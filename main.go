...
func buildApp(cfg *config.Config, db *sql.DB) (*mux.Router, context.CancelFunc) {
	...
	app.Handle("/events/{id}/roster", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.RosterPage)).Methods("GET")
	app.Handle("/events/{id}/tab/tenting", api.RequirePermission(authService, rbacRepo, "event:view", eventHandler.EventTentingTab)).Methods("GET")
	app.Handle("/events/{id}/tab/cooking", api.RequirePermission(authService, rbacRepo, "event:view", eventHandler.EventCookingTab)).Methods("GET")
	app.Handle("/events/{id}/tab/drivers", api.RequirePermission(authService, rbacRepo, "event:view", eventHandler.EventDriversTab)).Methods("GET")
	...
	app.Handle("/events/{id}/cooking/patrols", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.CookingCreatePatrol)).Methods("POST")
	app.Handle("/events/{id}/cooking/patrols/{patrol_id}", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.CookingDeletePatrol)).Methods("DELETE")
	app.Handle("/events/{id}/cooking/assign", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.CookingAssignMember)).Methods("POST")
	app.Handle("/events/{id}/cooking/patrols/{patrol_id}/members/{profile_id}", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.CookingRemoveMember)).Methods("DELETE")
	app.Handle("/events/{id}/cooking/patrols/{patrol_id}/cook/{profile_id}", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.CookingSetCook)).Methods("POST")
	app.Handle("/events/{id}/cooking/patrols/{patrol_id}/cook", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.CookingClearCook)).Methods("DELETE")
	app.Handle("/events/{id}/tents", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.TentCreate)).Methods("POST")
	app.Handle("/events/{id}/tents/{tent_id}", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.TentDelete)).Methods("DELETE")
	app.Handle("/events/{id}/tents/assign", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.TentAssignMember)).Methods("POST")
	app.Handle("/events/{id}/tents/members/{profile_id}", api.RequirePermission(authService, rbacRepo, "event:create", eventHandler.TentRemoveMember)).Methods("DELETE")
